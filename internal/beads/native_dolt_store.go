...
// AtomicTx reports whether Tx rolls the whole callback back on error. This
// commit still uses the sequential fallback; a later native-transaction commit
// upgrades it to true.
func (s *NativeDoltStore) AtomicTx() bool { return false }
