...
func (f *flakyTranscriptService) ensureMembershipLockedWriter(_ beads.Tx, input EnsureMembershipInput) (ConversationMembershipRecord, error) {
	return f.ensureMembershipLocked(input)
}
