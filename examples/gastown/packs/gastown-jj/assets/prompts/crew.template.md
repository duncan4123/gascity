...
WS_PATH={{ .CityRoot }}/.gc/workspaces/$TARGET_RIG/crew/{{ basename .AgentName }}-from-{{ .RigName }}
...
**Directory structure:**
```
{{ .CityRoot }}/.gc/workspaces/beads/crew/{{ basename .AgentName }}-from-{{ .RigName }}   # You (from {{ .RigName }}) working on beads
{{ .CityRoot }}/.gc/workspaces/gastown/crew/beads-alice                    # Alice (from beads) working on gastown
```
